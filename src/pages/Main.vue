<template>
  <div class="flex h-[100vh] w-[100%] items-center justify-center bg-[#030015]">
    <div
      class="calendar-container ml-[50px] h-[670px] w-[900px] rounded-[15px] border-1 border-[white] text-white 2xl:h-[676px] 2xl:w-[1000px]"
      style="
    ...
    >
      ...
      <div class="calendar-grid">
        ...
        <div
          class="flex h-[110px] cursor-pointer justify-around border-1 p-[0.5rem] 2xl:text-[18px]"
        ...
        >
          {{ day }}
          <div
            class="2xl: h-[100%] w-[80px] text-[14px] text-[18px] hover:scale-110"
          >
    ...
    >
      <div
        class="mt-[3px] flex h-[150px] w-[400px] flex-col rounded-[10px] border-1 bg-transparent p-10"
        style="
          box-shadow:
            0 0 5px 3px #00aa00,
            inset 0 0 5px #00aa00,
      ...
      <div
        class="mt-[50px] flex h-[200px] w-[400px] flex-col rounded-[10px] border-1 bg-transparent p-10"
        style="
          box-shadow:
            0 0 5px 3px #00aa00,
            inset 0 0 5px #00aa00,
